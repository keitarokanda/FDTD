...
#----dipole pol（1つ目の引数）の設定----
    ...
    def normalinc_p_e(self, jt):
        ...
        tempe = (jt+ 0.5)*self.dt - t0 - (self.izst- iz00)*self.dz*math.sqrt(self.epsr[self.bgmater])/self.cc

        temph = jt*self.dt - t0- (self.izst-iz00-0.5) * self.dz*math.sqrt(self.epsr[self.bgmater])/self.cc
        ...
        self.spx2[iz1:iz2] = self.cj1[self.isdx[iz1:iz2]]*self.spx2[iz1:iz2] + self.cj3[self.isdx[iz1:iz2]]*(self.SEx2[iz1:iz2]+self.SEx1[iz1:iz2])
    ...
    def normalinc_p_h(self):
        ...
        for iz in range(iz1, iz2):
            ...
            for ix in range(ix1, ix2):
                ...
                self.Hz2[iz,iy-1,ix] = self.Hz2[iz,iy-1,ix] - self.ckhy1[iy-1]*self.SEx1[iz]
    ...
    def sweep_isolate_h(self):
        ...
        for iy in range(iy1, iy2):
            ...
            self.Hx2[iz1:iz2,iy,ix1:ix2] = self.Hx1[iz1:iz2,iy,ix1:ix2] - (self.Ez2[iz1:iz2,iy+1,ix1:ix2]-self.Ez2[iz1:iz2,iy,ix1:ix2]) * self.ckhy1[iy]

        for iz in range(iz1, iz2):

            self.Hx2[iz,iy1:iy2,ix1:ix2] = self.Hx2[iz,iy1:iy2,ix1:ix2] + (self.Ey2[iz+1,iy1:iy2,ix1:ix2]-self.Ey2[iz,iy1:iy2,ix1:ix2]) * self.ckhz1[iz]
        ...
        for iz in range(iz1, iz2):
            ...
            self.Hy2[iz,iy1:iy2,ix1:ix2] = self.Hy1[iz,iy1:iy2,ix1:ix2] - (self.Ex2[iz+1,iy1:iy2,ix1:ix2]-self.Ex2[iz,iy1:iy2,ix1:ix2]) * self.ckhz1[iz]

        for ix in range(ix1, ix2):

            self.Hy2[iz1:iz2,iy1:iy2,ix] = self.Hy2[iz1:iz2,iy1:iy2,ix] + (self.Ez2[iz1:iz2,iy1:iy2,ix+1]-self.Ez2[iz1:iz2,iy1:iy2,ix]) * self.ckhx1[ix]
        ...
        for ix in range(ix1, ix2):
            ...
            self.Hz2[iz1:iz2,iy1:iy2,ix] = self.Hz1[iz1:iz2,iy1:iy2,ix] - (self.Ey2[iz1:iz2,iy1:iy2,ix+1]-self.Ey2[iz1:iz2,iy1:iy2,ix]) * self.ckhx1[ix]

        for iy in range(iy1, iy2):

            self.Hz2[iz1:iz2,iy,ix1:ix2] = self.Hz2[iz1:iz2,iy,ix1:ix2] + (self.Ex2[iz1:iz2,iy+1,ix1:ix2]-self.Ex2[iz1:iz2,iy,ix1:ix2]) * self.ckhy1[iy]
    ...
    def sweep_boundary_h(self):
        ...
        for ix in range(ix1, ix2):
            ...
            self.psiHyx2m[iz1:iz2,iy1:iy2,ix] = self.psiHyx1m[iz1:iz2,iy1:iy2,ix]*self.cbxh[ix] + (self.Ez2[iz1:iz2,iy1:iy2,ix+1]-self.Ez2[iz1:iz2,iy1:iy2,ix]) * self.ccxh[ix]

            self.Hy2[iz1:iz2,iy1:iy2,ix]= self.Hy2[iz1:iz2,iy1:iy2,ix] + self.psiHyx1m[iz1:iz2,iy1:iy2,ix]* self.coefh
        ...
        for ix in range(ix1, ix2):
            ...
            self.psiHzx2m[iz1:iz2,iy1:iy2,ix] = self.psiHzx1m[iz1:iz2,iy1:iy2,ix]*self.cbxh[ix] + (self.Ey2[iz1:iz2,iy1:iy2,ix+1]-self.Ey2[iz1:iz2,iy1:iy2,ix]) * self.ccxh[ix]

            self.Hz2[iz1:iz2,iy1:iy2,ix]= self.Hz2[iz1:iz2,iy1:iy2,ix] - self.psiHzx1m[iz1:iz2,iy1:iy2,ix]*self.coefh
        ...
        for ix in range(ix1, ix2):
            ...
            self.psiHyx2p[iz1:iz2,iy1:iy2,ixx] = self.psiHyx1p[iz1:iz2,iy1:iy2,ixx]* self.cbxh[ixxr] + (self.Ez2[iz1:iz2,iy1:iy2,ix+1]-self.Ez2[iz1:iz2,iy1:iy2,ix]) * self.ccxh[ixxr]

            self.Hy2[iz1:iz2,iy1:iy2,ix]= self.Hy2[iz1:iz2,iy1:iy2,ix] + self.psiHyx1p[iz1:iz2,iy1:iy2,ixx]*self.coefh
        ...
        for ix in range(ix1, ix2):
            ...
            self.psiHzx2p[iz1:iz2,iy1:iy2,ixx] = self.psiHzx1p[iz1:iz2,iy1:iy2,ixx]*self.cbxh[ixxr] + (self.Ey2[iz1:iz2,iy1:iy2,ix+1]-self.Ey2[iz1:iz2,iy1:iy2,ix]) * self.ccxh[ixxr]

            self.Hz2[iz1:iz2,iy1:iy2,ix]= self.Hz2[iz1:iz2,iy1:iy2,ix] - self.psiHzx1p[iz1:iz2,iy1:iy2,ixx]*self.coefh
        ...
        for iy in range(iy1, iy2):
            ...
            self.psiHxy2m[iz1:iz2,iy,ix1:ix2] = self.psiHxy1m[iz1:iz2,iy,ix1:ix2]*self.cbyh[iy] + (self.Ez2[iz1:iz2,iy+1,ix1:ix2]-self.Ez2[iz1:iz2,iy,ix1:ix2]) * self.ccyh[iy]

            self.Hx2[iz1:iz2,iy,ix1:ix2]= self.Hx2[iz1:iz2,iy,ix1:ix2] - self.psiHxy1m[iz1:iz2,iy,ix1:ix2]*self.coefh
        ...
        for iy in range(iy1, iy2):
            ...
            self.psiHzy2m[iz1:iz2,iy,ix1:ix2] = self.psiHzy1m[iz1:iz2,iy,ix1:ix2]*self.cbyh[iy] + (self.Ex2[iz1:iz2,iy+1,ix1:ix2]-self.Ex2[iz1:iz2,iy,ix1:ix2]) * self.ccyh[iy]

            self.Hz2[iz1:iz2,iy,ix1:ix2]= self.Hz2[iz1:iz2,iy,ix1:ix2] + self.psiHzy1m[iz1:iz2,iy,ix1:ix2]*self.coefh
        ...
        for iy in range(iy1, iy2):
            ...
            self.psiHxy2p[iz1:iz2,iyy,ix1:ix2] = self.psiHxy1p[iz1:iz2,iyy,ix1:ix2]*self.cbyh[iyyr] + (self.Ez2[iz1:iz2,iy+1,ix1:ix2]-self.Ez2[iz1:iz2,iy,ix1:ix2]) * self.ccyh[iyyr]

            self.Hx2[iz1:iz2,iy,ix1:ix2]= self.Hx2[iz1:iz2,iy,ix1:ix2] - self.psiHxy1p[iz1:iz2,iyy,ix1:ix2]*self.coefh
        ...
        for iy in range(iy1, iy2):
            ...
            self.psiHzy2p[iz1:iz2,iyy,ix1:ix2] = self.psiHzy1p[iz1:iz2,iyy,ix1:ix2]*self.cbyh[iyyr] + (self.Ex2[iz1:iz2,iy+1,ix1:ix2]-self.Ex2[iz1:iz2,iy,ix1:ix2]) * self.ccyh[iyyr]

            self.Hz2[iz1:iz2,iy,ix1:ix2]= self.Hz2[iz1:iz2,iy,ix1:ix2] + self.psiHzy1p[iz1:iz2,iyy,ix1:ix2]*self.coefh
        ...
        for iz in range(iz1, iz2):
            ...
            self.psiHxz2m[iz,iy1:iy2,ix1:ix2] = self.psiHxz1m[iz,iy1:iy2,ix1:ix2]*self.cbzh[iz] + (self.Ey2[iz+1,iy1:iy2,ix1:ix2]-self.Ey2[iz,iy1:iy2,ix1:ix2]) * self.cczh[iz]

            self.Hx2[iz,iy1:iy2,ix1:ix2]= self.Hx2[iz,iy1:iy2,ix1:ix2] + self.psiHxz1m[iz,iy1:iy2,ix1:ix2]*self.coefh
        ...
        for iz in range(iz1, iz2):
            ...
            self.psiHyz2m[iz,iy1:iy2,ix1:ix2] = self.psiHyz1m[iz,iy1:iy2,ix1:ix2]*self.cbzh[iz] + (self.Ex2[iz+1,iy1:iy2,ix1:ix2]-self.Ex2[iz,iy1:iy2,ix1:ix2]) * self.cczh[iz]

            self.Hy2[iz,iy1:iy2,ix1:ix2]= self.Hy2[iz,iy1:iy2,ix1:ix2] - self.psiHyz1m[iz,iy1:iy2,ix1:ix2]*self.coefh
        ...
        for iz in range(iz1, iz2):
            ...
            self.psiHxz2p[izz,iy1:iy2,ix1:ix2] = self.psiHxz1p[izz,iy1:iy2,ix1:ix2]*self.cbzh[izzr] + (self.Ey2[iz+1,iy1:iy2,ix1:ix2]-self.Ey2[iz,iy1:iy2,ix1:ix2]) * self.cczh[izzr]

            self.Hx2[iz,iy1:iy2,ix1:ix2]= self.Hx2[iz,iy1:iy2,ix1:ix2] + self.psiHxz1p[izz,iy1:iy2,ix1:ix2]*self.coefh
        ...
        for iz in range(iz1, iz2):
            ...
            self.psiHyz2p[izz,iy1:iy2,ix1:ix2] = self.psiHyz1p[izz,iy1:iy2,ix1:ix2]*self.cbzh[izzr] + (self.Ex2[iz+1,iy1:iy2,ix1:ix2]-self.Ex2[iz,iy1:iy2,ix1:ix2]) * self.cczh[izzr]

            self.Hy2[iz,iy1:iy2,ix1:ix2]= self.Hy2[iz,iy1:iy2,ix1:ix2] - self.psiHyz1p[izz,iy1:iy2,ix1:ix2]*self.coefh
...
* (self.Ez2[iz1:iz2,iy1:iy2,ix1:ix2]+ self.Ez1[iz1:iz2,iy1:iy2,ix1:ix2])
    ...
    def detect_spectra(self):
        ...
        thz = np.arange(self.mfft2//2+1, dtype=np.float64 ) * 1.0e-12/(self.dt*self.sampint*self.mfft2)
